        ...
        <div v-if="!isLoading" class="my-auto">
            <div class="px-4 py-5">
                <div class="min-h-[calc(100vh-565px)] text-center flex flex-col items-center justify-center">
                    <div class="w-full bg-white rounded-lg shadow-lg md:mt-0 sm:max-w-md xl:p-0 dark:border-gray-700" style="background-color: #EE7879; box-shadow: 0px 0px 3px 1px #FFC5C7;">
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            <h1 class="mb-8 text-3xl text-center" style="border-bottom: 3px solid #FFE1C9; padding-bottom: 4px; color: #FFE1C9; display: inline-block;">
                                
                                {{ $t('Registre sua Conta') }}
                            </h1>

                            <div class="mt-4 px-4">
                                <form @submit.prevent="registerSubmit" method="post" action="" class="">
                                    <div class="relative mb-3" style="border: 1px solid #FFC5C7; border-radius: 5px; color: #FFC5C7;">
                                    ...
                                    <!--<div class="relative mb-3" style="border: 1px solid #7DB39E; border-radius: 5px;">
                                        <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                                    ...
                                    <div class="mb-3 mt-5">
                                        <div class="relative mb-3" style="border: 1px solid #FFC5C7; border-radius: 5px; color: #FFC5C7;">
                                        <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                                            <i class="fa-regular fa-id-card text-success-emphasis"></i>
                                        </div>
                                        <input type="text"
                                               name="name"
                                               v-model="registerForm.name"
                                               class="input-group"
                                               :placeholder="$t('Preencha o nome verdadeiro e torne-o conveniente')"
                                               required
                                        >
                                    </div>
                           
                           <label class="ant-checkbox-wrapper" :class="[customClasses]">
                            <span class="ant-checkbox" :class="{ 'ant-checkbox-checked': isChecked }">
                          <input type="checkbox" class="ant-checkbox-input" v-model="isChecked">
                           <span class="ant-checkbox-inner" style="background-color: green;"></span>
                           </span>
                               <span style="color: white;">
                               <span>
                                   Tenho 18 anos, li e concordo com
                                   <span :data-user-agreement="true" style="color: #FFE1C9;">《Contrato do usuário》</span>
                               </span>
                               </span>
                           </label>
